    ...
    <div class="tbl">
        <div>
            <table class="tbl" style="overflow: scroll">
                <tr>
                    <td class="tblhead" bgcolor="#369">Attendance
                        <br />
                    </td>
                </tr>
            </table>
            ...
            <table class="auto-style1" bgcolor="white" border="1" frame="box">
                <tr>
                    ...
                    <td class="auto-style4">
                        <asp:DropDownList ID="DropDownList1" runat="server" Height="31px" Width="336px" DataSourceID="SqlDataSource2" DataTextField="course" DataValueField="course">
                        </asp:DropDownList>
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:OTeachingConnectionString3 %>" ProviderName="<%$ ConnectionStrings:OTeachingConnectionString3.ProviderName %>" SelectCommand="SELECT [course] FROM [CourseMst]"></asp:SqlDataSource>
                    </td>
                </tr>
        ...
        <div>
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <asp:Button ID="Button2" Text="Schedule" runat="server" OnClick="Button2_Clicked" CssClass="btn" /><br />
                    </td>
                </tr>
