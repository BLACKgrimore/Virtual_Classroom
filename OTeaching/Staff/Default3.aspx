...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div>
     ...
     <table class="auto-style1" bgcolor="white" border="1" frame="box">
      <tr>
            <td class="auto-style3" align="center" ><b>SeleSelect Branch</b></td>
            <td class="auto-style4">
                <asp:DropDownList ID="DropDownList1" runat="server" Height="31px" Width="336px" DataSourceID="SqlDataSource3" DataTextField="course" DataValueField="course">
                </asp:DropDownList>
                <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:OTeachingConnectionString4 %>" ProviderName="<%$ ConnectionStrings:OTeachingConnectionString4.ProviderName %>" SelectCommand="SELECT [course] FROM [CourseMst]"></asp:SqlDataSource>
            </td>
        </tr>
        <tr>
            <td class="auto-style3" align="center" ><b>Select Course
